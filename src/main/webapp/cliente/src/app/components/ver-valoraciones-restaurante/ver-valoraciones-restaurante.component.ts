...
@Component({
  selector: 'app-ver-valoraciones-restaurante',
  templateUrl: './ver-valoraciones-restaurante.component.html',
  styleUrls: ['./ver-valoraciones-restaurante.component.css']
})
export class VerValoracionesRestauranteComponent implements OnInit {
