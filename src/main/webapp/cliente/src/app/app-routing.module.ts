...
import { EntregasClientesComponent } from './components/entregas-clientes/entregas-clientes.component';
...
const routes: Routes = [
  ...
  { path: 'estregas-cliente', component: EntregasClientesComponent},
